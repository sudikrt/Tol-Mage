...
if($err!="") {
	switch($err) {
		case 0: $err_msg = "Enter the Branch_code";
			break;
		case 1: $err_msg = "Branch_not exists";
			break;
...
<html>
<head>
	<title>Removing Branch Info</title>
		<meta charset="utf-8">
...
<body>
	 ...
	 <div class="main">
		<div class="login-form">
			<h1>Remove Branch Info</h1>
					<div class="head">
						<img src="images/user.png" alt=""/>
					</div>
				<form method = "POST" action = "delete_branch.php">
